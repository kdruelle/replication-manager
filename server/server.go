...
func (repman *ReplicationManager) AddFlags(flags *pflag.FlagSet, conf *config.Config) {
	...
	flags.StringVar(&conf.BackupWhiteList, "backup-white-list", "", "Whitelist DB Backup")
	flags.StringVar(&conf.BackupExcludeList, "backup-exclude-list", "", "Exclude List DB Backup")
